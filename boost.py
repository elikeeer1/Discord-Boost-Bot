...
async def join_server(token, inv):
  ...
  async with aiohttp.ClientSession(headers=headers) as serverjoinersession:
    async with serverjoinersession.post(f"https://discord.com/api/v9/invites/{inv}") as response:https://discord.gg/e5HgWyWF
...
async def start_join(inv):https://discord.gg/e5HgWyWF
